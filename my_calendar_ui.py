...
def renderCalendarUI(mainImage, current_date, extra_text, weather_data):
    ...
    mainDraw.line((0, separatorPosition, viewport_width, monthPosition + calendar_config['linesGap']), fill = FILL_BLACK)
    mainDraw.multiline_text((middlePoint, textPosition), extra_text, font = FONTS['support_text'], fill = FILL_BLACK)
