...
def renderTwoLinesList(draw, items, count):
    for j in range(0, count):
        ...
        draw.line((0, itemPosition + CONFIG['listItemHeight'], 150, itemPosition + CONFIG['listItemHeight']), fill = FILL_BLACK)
        draw.rectangle((16, itemPosition + (CONFIG['listItemHeight'] - 16 - 14 - 4) / 2, 134, itemPosition + ((CONFIG['listItemHeight'] - 16 - 14 - 4) / 2) + 16), outline = FILL_BLACK)
        ...
        draw.rectangle((16, itemPosition + ((CONFIG['listItemHeight'] - 16 - 14 - 4) / 2) + 16 + 4, 134, itemPosition + ((CONFIG['listItemHeight'] - 16 - 14 - 4) / 2) + 16 + 4 + 14), outline = FILL_BLACK)