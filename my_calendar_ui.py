...
def renderList(draw, items, count):
    for j in range(0, count):
        ...
        if itemValue['due']:
            ...
            draw.rectangle((16, itemPosition + (CONFIG['listItemHeight'] - 16 - 14) / 2, 134, itemPosition + ((CONFIG['listItemHeight'] - 16 - 14) / 2) + 16), outline = FILL_BLACK)
            ...
            draw.rectangle((12, itemPosition + ((CONFIG['listItemHeight'] - 16 - 14) / 2) + 16, 134, itemPosition + ((CONFIG['listItemHeight'] - 16 - 14) / 2) + 16 + 14), outline = FILL_BLACK)
        else:
